...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | 指尖琉璃")[0];
}
...
$.ajax({
  ...
  data: {
    key: 'Z3IBZ-PCRWZ-SRDXV-7Q3J2-QQFPV-WOBU7',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(120.64517, 31.13914, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
  ...
  try {
    ...
    document.getElementById("welcome-info").innerHTML =
      `<b><center>😄 有朋自远方来 😄</center>&emsp;&emsp;欢迎来自 <span style="color:var(--theme-color)">${pos}</span> 的小伙伴，${timeChange}您现在距离站长约 <span style="color:var(--theme-color)">${dist}</span> 公里，当前的IP地址为： <span style="color:var(--theme-color)">${ip}</span>， ${posdesc}</b>`;
  } catch (err) {
...
function createtime1() {
  var grt = new Date("05/09/2023 00:00:00"); //此处修改你的建站时间或者网站上线时间
 ...
 ___  _                       _    _                 _                     _            _   
| __><_>._ _  ___  ___  _ _ _| |_ <_> ___  ___  ___ | | ___ .___ ___  ___ | | _ _  ___ | |__
| _> | || ' |/ . |/ ._>| '_> | |  | || . \\|___|/ . || |<_> | / // ._>|___|| || | |/ | '| / /
|_|  |_||_|_|\\_. |\\___.|_|   |_|  |_||  _/     \\_. ||_|<___|/___\\___.     |_|\`___|\\_|_.|_\\_\\
             <___'                   |_|       <___'                                        
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by 指尖琉璃 %c 你正在访问指尖琉璃の小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| 指尖琉璃") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('指尖琉璃的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制信息🎇",
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://cdn.staticaly.com/gh/Fingertip-glaze-luck/tuchuang@main/imgs/ymbj-bt.jpg);
    --darkmode-bg: url(https://cdn.staticaly.com/gh/Fingertip-glaze-luck/tuchuang@main/imgs/ymbj-yw.jpg);
    --mobileday-bg: url(https://cdn.staticaly.com/gh/Fingertip-glaze-luck/tuchuang@main/imgs/sjbz.jpg);
    --mobilenight-bg: url(https://cdn.staticaly.com/gh/Fingertip-glaze-luck/tuchuang@main/imgs/sjbz.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
